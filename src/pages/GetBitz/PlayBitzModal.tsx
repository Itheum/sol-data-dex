...
export const PlayBitzModal: React.FC<PathwaysModalProps> = (props) => {
  ...
  return (
    <div
      id="static-modal"
      aria-hidden="true"
      className={`${showPlayBitzModel ? "visible" : "hidden"} flex md:mt-[-50px] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 bg-[#000000d9]`}>
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        <div className="relative bg-white rounded-lg dark:bg-[#171717] drop-shadow-[0_0px_100px_rgba(250,250,250,.8)]">
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mr-auto">Play To Get BiTz XP</h3>
