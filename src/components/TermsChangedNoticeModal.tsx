        ...
        <ModalBody py={6}>
          ...
          <Box fontSize="sm" mt="3">
            ...
            <Text mb="2">
              ...
              <Link href="https://docs.itheum.io/product-docs/legal/ecosystem-tools-terms/datadex/terms-of-use" isExternal textDecoration="underline">
                https://docs.itheum.io/product-docs/legal/ecosystem-tools-terms/datadex/terms-of-use
              </Link>
            </Text>
